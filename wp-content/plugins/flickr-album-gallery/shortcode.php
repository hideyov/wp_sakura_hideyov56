...
function FlickerAlbumGalleryShortCode( $Id ) {
	...
	wp_enqueue_style('fag-site-css', FAG_PLUGIN_URL.'css/fag-shortcode-style.css');
					...
					if(is_array($FAG_Albums)){
						foreach($FAG_Albums as $FAG_Album) {							
							    ...
							    function Plugin(element, options) {
							        ...
							        this._printGallery = function(photos) {
							            ...
							            $.each(photos, function(key, photo) {
							                ...
							                element.append($('<div></div>', { 'class': ' <?php echo $FAG_Col_Layout; ?> col-sm-4 col-center wpfrank-flickr-div' })
							...
							<div class="gallery<?php echo $ID; ?>">
								...
								<h3><?php echo ucwords(get_the_title($ID)); ?></h3>
								<?php } ?>
								<div class="row">
